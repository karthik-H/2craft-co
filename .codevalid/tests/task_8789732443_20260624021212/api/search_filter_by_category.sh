...
VALUES ('${SELLER_PROFILE_ID}', '${SELLER_USER_ID}', 'Category Filter Store ${CASE_SUFFIX}', '');
INSERT INTO products (id, seller_id, title, description, category, price_cents, stock_qty, photos, status, visible, created_at)
VALUES
  ('${PROD1_ID}', '${SELLER_PROFILE_ID}', 'Laptop', 'Electronics laptop', 'electronics', 90000, 10, '[]', 'ACTIVE', true, NOW() - INTERVAL '3 minutes'),
  ('${PROD2_ID}', '${SELLER_PROFILE_ID}', 'Novel', 'Books novel', 'books', 1500, 10, '[]', 'ACTIVE', true, NOW() - INTERVAL '2 minutes'),
  ('${PROD3_ID}', '${SELLER_PROFILE_ID}', 'Phone', 'Electronics phone', 'electronics', 50000, 5, '[]', 'ACTIVE', true, NOW() - INTERVAL '1 minute');
SQL
